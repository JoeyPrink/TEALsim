 ...
 * 
 * $Id: MoveNode.java,v 1.15 2010/07/16 21:41:34 stefan Exp $ 
 * 
 */
...
/**
 * build the gizmo of movegizmo
 * @author john
 * 
 */
public class MoveNode extends Node3D
{
    ...
    {
        TDebug.println(0,"BaseX:");
        GeomUtil.printGeometry(sBaseX);
        TDebug.println(0,"BaseY:");
        GeomUtil.printGeometry(sBaseY);
        TDebug.println(0,"BaseZ:");
        GeomUtil.printGeometry(sBaseZ);
    }
    ...
    public void setElement(TAbstractRendered element)
    {
        ...
        if (element != null)
        {
            TDebug.println(0,"moveGizmo setting element: " +element);
            ...
            if (bnds != null)    
            {
                ...
                TDebug.println(0," scale = " + 2.0 * bs.getRadius());
