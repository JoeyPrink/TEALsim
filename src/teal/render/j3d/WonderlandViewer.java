...
public class WonderlandViewer extends teal.render.viewer.AbstractViewer3D {
     ...
     */
    public WonderlandViewer(boolean useDefaultScene, boolean tryStereo) {
        super();
	    ...
	    renderFlags ^= AbstractViewer3D.BACKGROUND_CHANGED;
         bgNode.setApplicationBounds(AbstractViewer3D.sInfiniteBounds);
...
//        setPicking(true);
    ...
    */
    ...
    synchronized public void addDrawableBulk(Collection drawn) {
    	this.drawObjects.addAll(drawn);
    }
    
    synchronized public void removeDrawableBulk(Collection drawn) {
    ...
    */
    ...
    public void render(boolean doRepaint) {	
        ...
        synchronized(drawObjects) {
	        ...
	        while (it.hasNext())
	        {
	           (( TAbstractRendered)it.next()).render();
	        }
        }
