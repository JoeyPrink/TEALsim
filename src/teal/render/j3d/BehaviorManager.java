 ...
 * 
 * $Id: BehaviorManager.java,v 1.32 2010/07/21 21:46:49 stefan Exp $ 
 * 
 */
...
public boolean getCursorOnDrag()
{
   ...
   public SelectManager getSelectManager() {
    ...
    public void setViewer(TViewer viewer) {
        mViewer = (ViewerJ3D) viewer;
        setPickCanvas(mViewer.getPickCanvas());
        setSelectManager(mViewer.getSelectManager());
 ...
 */   
        ...
        if ((flag != navMode) || (getVpBehavior() == null)) {
            ...
            /*		
                ...
                */
                ...
                orbitBehavior.setSchedulingBounds(ViewerJ3D.sInfiniteBounds);
    ...
    */
    ...
    public void setTransform(Quat4d rot, Vector3d pos) {
        setTransform(new Transform3D(rot,pos,1.0));
    }

    public void setTransform(Quat4d rot,Vector3d pos,double scale) {
    ...
    {
        return new Vector3d(((OrbitBehavior)getVpBehavior()).getTransXFactor(),
        ...
        public void mousePressed(MouseEvent me) {
            ...
            if (button == MouseEvent.BUTTON1) {
                ...
                if (selectManager.disableVpBehaviorWhileSelecting()) 
                	if(getVpBehavior() != null)
                		getVpBehavior().setEnable(clearSelected);
            }
                ...
                if (selectManager.disableVpBehaviorWhileSelecting()){ 
                	if(getVpBehavior() != null)
                		getVpBehavior().setEnable(selectManager.isSelectionEmpty());
                }
            }
                    ...
                    switch (mode) {
                      case TViewer.ROTATE:
                        ...
                        case TViewer.TRANSLATE:				
                            while (it.hasNext()) {
                                obj = (TAbstractRendered) it.next();
                                Vector3d pos = new Vector3d(obj.getPosition());
                                pos.add(vec);
