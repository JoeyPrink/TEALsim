 ...
 * 
 * $Id: ArrowWallNode.java,v 1.8 2010/04/15 15:47:42 pbailey Exp $ 
 * 
 */
...
public class ArrowWallNode extends WallNode {
	...
	public ArrowWallNode() {
		...
		offset.setTranslation(new Vector3d(0f,-0.5f,0f));
		...
		Appearance arrowAppearance = Node3D.makeAppearance(new Color4f(new Color(0,50,250)),0.f);
