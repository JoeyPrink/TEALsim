...
public class BasicTaskPaneGroupUI extends TaskPaneGroupUI {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 3415396761239777129L;
...
private static FocusListener focusListener = new RepaintOnFocus();
  ...
  static class RepaintOnFocus implements FocusListener, Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = -6455945967442108258L;
  ...
  class ToggleListener extends MouseInputAdapter implements Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 3139896677070105615L;
  ...
  class ToggleExpandedAction extends AbstractAction implements Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = 2084510800734122294L;
  ...
  protected static class ChevronIcon implements Icon, Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = -8402470576400162437L;
	boolean up = true;
   ...
   */
  protected static class ContentPaneBorder implements Border, Serializable {
    /**
	 * 
	 */
	private static final long serialVersionUID = -8762510181075451897L;
	Color color;
   ...
   *  
   */
  protected static class PaneBorder implements Border, Serializable {

    /**
	 * 
	 */
	private static final long serialVersionUID = 452266441928719275L;
