 ...
 * 
 * The first test that evaluates to true determines the index for the skin to be
 * used.
 * 
...
public class SkinSimpleButtonIndexModel {
	 ...
	 * 
	 * @param normal
	 *            the index of the normal image
	 * @param rollover
	 *            the index of the rollover image
	 * @param pressed
	 *            the index of the pressed image
	 * @param disabled
	 *            the index of the disabled image
	 */
	...
	/**
	 * Returns the index of the image of the skin to be used for rendering. The
	 * button must be set before calling <code>getIndexForState</code>.
	 * 
	 * @see #setButton(AbstractButton)
	 * @return int the index of the image that should be used for rendering due
	...
	/**
	 * This methode can be used for other Components than AbstractButtons. The
	 * states are passed directly, but the logic to decide which index to use is
	 * the same as in <code>getIndexForState</code> so that consistency is
	 * preserved.
	 * 
	 * @param isEnabled
	 * @param isPressed
