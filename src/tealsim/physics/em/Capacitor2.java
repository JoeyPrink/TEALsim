/* $Id: Capacitor2.java,v 1.10 2010/07/16 21:41:40 stefan Exp $ */
 ...
 *
 */
public class Capacitor2 extends SimEM {
...
//      Building the world.
    ...
    void addActions() {
        TealAction ta = new TealAction("Capacitor2", this);
        addAction("Help", ta);
    }
    ...
    ArrayList pcList1 = new ArrayList();
    ArrayList pcList2 = new ArrayList();
