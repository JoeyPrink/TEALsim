...
import teal.physics.em.ElectricDipole;
...
public class TorqueOnDipoleE extends SimEM {

    private static final long serialVersionUID = 3977859583605880629L;
    JButton but;
    JButton but1;
    ...
    public TorqueOnDipoleE() {

        super();

        title = "Torque on an Electric Dipole";
        ...
        BField.setType(ConstantField.E_FIELD);
        ...
        slider4.addRoute("value", theEngine, "damping");
...
//            flux[i] = theEngine.getEField().getFlux(pos);
            flux[i] = theEngine.getElementByType(EField.class).getFlux(pos);
        ...
        viz.setConvolutionModes(DLIC.DLIC_FLAG_E | DLIC.DLIC_FLAG_EP);
    ...
    void initFieldLines() {
        ...
        for (int i = 0; i < flux.length; i++) {
            ...
            tempfls5[i].setType(Field.E_FIELD);
            ...
            tempfls6[i].setType(Field.E_FIELD);
