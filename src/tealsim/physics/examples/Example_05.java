/* $Id: Example_05.java,v 1.6 2010/07/16 21:41:46 stefan Exp $ */
/**
 * @author John Belcher 
 * Revision: 1.0 $
 */
 ...
 * a fixed charge located underneath a wall, with a vector field grid to show the direction of the field.  
 * We have a slider that can be used to vary the charge
 ...
 * @version 1.0 
 * */
public class Example_05 extends SimEM {
    ...
    public Example_05() {
        ...
        // setType() sets the type of field that this vector field grid should measure.
        fv.setType(Field.E_FIELD);
        
        // Here we create a VisualizationControl Group.  
        // VisualizationControl constructor.
        visControl = new VisualizationControl();
        // setFieldVisGrid sets the FieldDirectionGrid associated with this Group.  
        // This is the grid we created above.
